...
namespace Application.Testes.Services
{
    public class UserServiceTests
    {
        ...
        {
            userService = new UserServices(new Mock<IUserRepository>().Object, new Mock<IMapper>().Object);
        }
        ...
        //{
        //    var result = userService.Post(new UserViewModel { Name = "User Default", Email = "userdefault@template.com", Password="1q2w3e4r" });
        //    Assert.True(result);
        //}
        ...
        public void Get_ValidatingObject()
        {
            ...
            userService = new UserServices(_userRepository.Object, _mapper);
